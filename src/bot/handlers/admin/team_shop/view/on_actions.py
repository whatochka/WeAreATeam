...
from ..create.states import CreateTeamProductStates
from ..edit.states import EditTeamProductStates
...
async def on_create_product(
    ...
    await dialog_manager.start(state=CreateTeamProductStates.name)
...
async def on_edit_price(
    ...
    await dialog_manager.start(
        state=EditTeamProductStates.price,
...
async def on_edit_stock(
    ...
    product_id: ProductId = dialog_manager.dialog_data["product_id"]
    await dialog_manager.start(
        state=EditTeamProductStates.stock,
        data={"product_id": product_id},
    )
