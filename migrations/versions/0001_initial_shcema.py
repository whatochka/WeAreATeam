...
Revision ID: 0001
Revises: 
Create Date: 2025-02-21 03:35:34.646008
...
def upgrade() -> None:
    ...
    op.create_table('pre_registered_users',
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('pk_pre_registered_users')),
    sa.UniqueConstraint('number', name=op.f('uq_pre_registered_users_number')),
    sa.UniqueConstraint('tg_username', name=op.f('uq_pre_registered_users_tg_username'))
    )
