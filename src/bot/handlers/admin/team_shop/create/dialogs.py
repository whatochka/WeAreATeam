...
from .states import CreateTeamProductStates
...
product_name_window = Window(
    ...
    state=CreateTeamProductStates.name,
)
...
product_description_window = Window(
    ...
    GoToProductsButton(),
    GoToAdminPanelButton(),
    state=CreateTeamProductStates.description,
)
...
product_price_window = Window(
    ...
    GoToProductsButton(),
    GoToAdminPanelButton(),
    state=CreateTeamProductStates.price,
)
...
product_stock_window = Window(
    ...
    GoToProductsButton(),
    GoToAdminPanelButton(),
    state=CreateTeamProductStates.stock,
)
...
confirm_create_product_window = Window(
    ...
    GoToProductsButton(),
    GoToAdminPanelButton(),
    state=CreateTeamProductStates.confirm,
)

create_team_product_dialog = Dialog(
    product_name_window,
